...
spline_polylines = compas_rhino.objects.get_polyline_coordinates(guids)

guids = compas_rhino.objects.get_polylines(layer="cables")
cable_polylines = compas_rhino.objects.get_polyline_coordinates(guids)
...
data = {"network": network, "splines": splines, "cables": cables}
